...
import advanced.stage8.cardgames.BlackJack;
import advanced.stage8.cardgames.GoFish;
...
public final class Casino {
    ...
    public static void selectGame() {
        String gameSelection = Display.getStringInput("Would you like to play [BlackJack] or [GoFish]?");
        if (gameSelection.equalsIgnoreCase("gofish")) {
            gofish.play();
        } else {
            blackjack.start();
        }
